...
class DataLoaderLeader(DataLoaderTest):
    ...
    def generate_batch(self):
        ...
        for file in self.test_files:
            ...
            print(f'Start processing file: {file}, Total lines: {num_lines}')
            ...
            for line in open(file, 'r'):
                ...
                if len(impids) == self.args.batch_size:
                    # Hiển thị thông tin về batch hiện tại
                    total_batches += 1
                    print(f'Yielding batch {total_batches}, size: {len(impids)}')
        ...
        print(f'Finished processing all files. Total batches generated: {total_batches}')